...
public final class blockPlaceChecker implements Listener
{
        ...
        if (block.getType() == Material.END_PORTAL_FRAME)
        {
            ...
            else if (main.Global.configToggleBlockCheck)
            {
                if (main.Global.configToggleBlockCheck_50)
                {
                    ...
                    {blockChunkCheck(chunk, placedType, x, y, z, name);}
                }
                else blockChunkCheck(chunk, placedType, x, y, z, name);
            }
    ...
    /////////////////////////////////////////////////////////////////////////////
    private static void blockChunkCheck(Chunk chunk, Material placedType, int x, int y, int z, String name)
    {
